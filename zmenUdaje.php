...
<div class="row">
    ...
    <div class="oStranke">
        ...
        <form method="post" name="form">
            <br>
            <input type="text" placeholder="Nové používat. meno" name="newName" required>
            <br>
            <br>
            <input type="password" placeholder="Nové heslo" name="newPassword" required>
            <br>
            <br>
            <input type="text" placeholder="Nový e-mail" name="newEmail" required>
            <br>
            <br>
